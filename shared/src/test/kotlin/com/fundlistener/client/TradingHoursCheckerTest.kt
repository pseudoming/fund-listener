...
class TradingHoursCheckerTest {
    ...
    @Test
    fun `cacheTtlSeconds for normal stock returns 30, 300 or 3600`() {
        val ttl = TradingHoursChecker.cacheTtlSeconds(isSuspended = false)
        // Must be one of the valid TTLs
        assertTrue(ttl == 30L || ttl == 300L || ttl == 3600L, "Expected 30, 300 or 3600 but got $ttl")
    }
