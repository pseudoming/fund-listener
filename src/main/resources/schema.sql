...
CREATE INDEX IF NOT EXISTS idx_nav_fund_code ON nav_history(fund_code);
...
CREATE INDEX IF NOT EXISTS idx_vs_fund_code ON valuation_snapshot(fund_code);
CREATE INDEX IF NOT EXISTS idx_vs_snapshot_time ON valuation_snapshot(snapshot_time);
